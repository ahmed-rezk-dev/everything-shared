...
import importedNativeCode from '@/../node_modules/@everything-shared/navigation-menu/src/navigation-menu.tsx?raw';
import importedWebCode from '@/../node_modules/@everything-shared/navigation-menu/src/navigation-menu.web.tsx?raw';
import importedTypesCode from '@/../node_modules/@everything-shared/navigation-menu/src/types.ts?raw';
import importedIndexCode from '@/../node_modules/@everything-shared/navigation-menu/src/index.ts?raw';
...
<Tabs>
  ...
  Install the component via your command line.
    ...
    ```bash
    npx expo install @everything-shared/navigation-menu
    ```
