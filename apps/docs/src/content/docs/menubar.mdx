...
import importedNativeCode from '@/../node_modules/@everything-shared/menubar/src/menubar.tsx?raw';
import importedWebCode from '@/../node_modules/@everything-shared/menubar/src/menubar.web.tsx?raw';
import importedTypesCode from '@/../node_modules/@everything-shared/menubar/src/types.ts?raw';
import importedIndexCode from '@/../node_modules/@everything-shared/menubar/src/index.ts?raw';
...
<Tabs>
  ...
  Install the component via your command line.
    ...
    ```bash
    npx expo install @everything-shared/menubar
    ```
