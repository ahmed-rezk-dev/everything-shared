...
import importedNativeCode from '@/../node_modules/@everything-shared/dropdown-menu/src/dropdown-menu.tsx?raw';
import importedWebCode from '@/../node_modules/@everything-shared/dropdown-menu/src/dropdown-menu.web.tsx?raw';
import importedTypesCode from '@/../node_modules/@everything-shared/dropdown-menu/src/types.ts?raw';
import importedIndexCode from '@/../node_modules/@everything-shared/dropdown-menu/src/index.ts?raw';
...
<Tabs>
  ...
  Install the component via your command line.
    ...
    ```bash
    npx expo install @everything-shared/dropdown-menu
    ```
