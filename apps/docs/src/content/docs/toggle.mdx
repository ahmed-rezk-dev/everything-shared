...
import importedNativeCode from '@/../node_modules/@everything-shared/toggle/src/toggle.tsx?raw';
import importedWebCode from '@/../node_modules/@everything-shared/toggle/src/toggle.web.tsx?raw';
import importedTypesCode from '@/../node_modules/@everything-shared/toggle/src/types.ts?raw';
import importedIndexCode from '@/../node_modules/@everything-shared/toggle/src/index.ts?raw';
...
<Tabs>
  ...
  Install the component via your command line.
    ...
    ```bash
    npx expo install @everything-shared/toggle
    ```
