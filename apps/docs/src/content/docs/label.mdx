...
import importedNativeCode from '@/../node_modules/@everything-shared/label/src/label.tsx?raw';
import importedWebCode from '@/../node_modules/@everything-shared/label/src/label.web.tsx?raw';
import importedTypesCode from '@/../node_modules/@everything-shared/label/src/types.ts?raw';
import importedIndexCode from '@/../node_modules/@everything-shared/label/src/index.ts?raw';
...
<Tabs>
  ...
  Install the component via your command line.
    ...
    ```bash
    npx expo install @everything-shared/label
    ```
