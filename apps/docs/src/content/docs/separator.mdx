...
import importedCode from '@/../node_modules/@everything-shared/separator/src/separator.tsx?raw';
import importedTypesCode from '@/../node_modules/@everything-shared/separator/src/types.ts?raw';
...
<Tabs>
  ...
  Install the component via your command line.
    ...
    ```bash
    npx expo install @everything-shared/separator
    ```
