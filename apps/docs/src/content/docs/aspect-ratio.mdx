...
import importedCode from '@/../node_modules/@everything-shared/aspect-ratio/src/aspect-ratio.tsx?raw';
...
<Tabs>
  ...
  Install the component via your command line.
    ...
    ```bash
    npx expo install @everything-shared/aspect-ratio
    ```
...
```tsx
import * as AspectRatio from '@everything-shared/aspect-ratio';
