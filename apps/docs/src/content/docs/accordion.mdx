...
import importedNativeCode from '@/../node_modules/@everything-shared/accordion/src/accordion.tsx?raw';
import importedWebCode from '@/../node_modules/@everything-shared/accordion/src/accordion.web.tsx?raw';
import importedTypesCode from '@/../node_modules/@everything-shared/accordion/src/types.ts?raw';
import importedIndexCode from '@/../node_modules/@everything-shared/accordion/src/index.ts?raw';
...
<Tabs>
  ...
  Install the component via your command line.
    ...
    ```bash
    npx expo install @everything-shared/accordion
    ```
