...
import importedNativeCode from '@/../node_modules/@everything-shared/checkbox/src/checkbox.tsx?raw';
import importedWebCode from '@/../node_modules/@everything-shared/checkbox/src/checkbox.web.tsx?raw';
import importedTypesCode from '@/../node_modules/@everything-shared/checkbox/src/types.ts?raw';
import importedIndexCode from '@/../node_modules/@everything-shared/checkbox/src/index.ts?raw';
...
<Tabs>
  ...
  Install the component via your command line.
    ...
    ```bash
    npx expo install @everything-shared/checkbox
    ```
