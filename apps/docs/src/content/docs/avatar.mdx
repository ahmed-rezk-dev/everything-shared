...
import importedNativeCode from '@/../node_modules/@everything-shared/avatar/src/avatar.tsx?raw';
import importedTypesCode from '@/../node_modules/@everything-shared/avatar/src/types.ts?raw';
...
<Tabs>
  ...
  Install the component via your command line.
    ...
    ```bash
    npx expo install @everything-shared/avatar
    ```
