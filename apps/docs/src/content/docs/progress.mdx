...
import importedNativeCode from '@/../node_modules/@everything-shared/progress/src/progress.tsx?raw';
import importedWebCode from '@/../node_modules/@everything-shared/progress/src/progress.web.tsx?raw';
import importedTypesCode from '@/../node_modules/@everything-shared/progress/src/types.ts?raw';
import importedIndexCode from '@/../node_modules/@everything-shared/progress/src/index.ts?raw';
...
<Tabs>
  ...
  Install the component via your command line.
    ...
    ```bash
    npx expo install @everything-shared/progress
    ```
