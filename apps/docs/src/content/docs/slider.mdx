...
import importedNativeCode from '@/../node_modules/@everything-shared/slider/src/slider.tsx?raw';
import importedWebCode from '@/../node_modules/@everything-shared/slider/src/slider.web.tsx?raw';
import importedTypesCode from '@/../node_modules/@everything-shared/slider/src/types.ts?raw';
import importedIndexCode from '@/../node_modules/@everything-shared/slider/src/index.ts?raw';
...
<Tabs>
  ...
  Install the component via your command line.
    ...
    ```bash
    npx expo install @everything-shared/slider
    ```
