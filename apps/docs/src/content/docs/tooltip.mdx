...
import importedNativeCode from '@/../node_modules/@everything-shared/tooltip/src/tooltip.tsx?raw';
import importedWebCode from '@/../node_modules/@everything-shared/tooltip/src/tooltip.web.tsx?raw';
import importedTypesCode from '@/../node_modules/@everything-shared/tooltip/src/types.ts?raw';
import importedIndexCode from '@/../node_modules/@everything-shared/tooltip/src/index.ts?raw';
...
<Tabs>
  ...
  Install the component via your command line.
    ...
    ```bash
    npx expo install @everything-shared/tooltip
    ```
