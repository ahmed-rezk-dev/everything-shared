...
import importedCode from '@/../node_modules/@everything-shared/utils/src/index.ts?raw';
...
<Tabs>
  ...
  Install the component via your command line.
    ...
    ```bash
    npx expo install @everything-shared/utils
    ```
  </TabItem>
...
```tsx
import { ToggleGroupUtils } from '@everything-shared/hooks';
...
```tsx
import { EmptyGestureResponderEvent } from '@everything-shared/hooks';
import type { PressableRef, SlottablePressableProps } from '@everything-shared/types';
